...
const cardBase = `relative flex flex-col md:flex-row items-center bg-white/70 backdrop-blur-md border rounded-2xl shadow-2xl overflow-hidden transition-transform duration-300 hover:scale-105 group`;
